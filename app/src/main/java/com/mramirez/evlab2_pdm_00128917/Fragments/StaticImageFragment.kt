...
class StaticImageFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        view.findViewById<ImageView>(R.id.leftButton).setOnClickListener{
            listener?.onClick("left")
        }

        view.findViewById<ImageView>(R.id.rightButton).setOnClickListener {
